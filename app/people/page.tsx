      ...
      <div className="pt-32 pb-20 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            Our
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">People</span>
          </motion.h1>
          ...
          >
            {/* Hussien Ballouk */}
            <div className="glass rounded-3xl p-10 relative overflow-hidden group hover:bg-white/[0.06] transition-all duration-500 border border-white/5 hover:border-white/10">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#3b82f6]/10 to-transparent rounded-full blur-3xl -z-10 group-hover:opacity-100 transition-opacity duration-500" />

              <div className="flex flex-col items-center text-center gap-8">
                {/* Avatar */}
                <div className="relative w-48 h-48 sm:w-56 sm:h-56">
                  <div className="relative w-full h-full rounded-2xl overflow-hidden border border-white/10 shadow-2xl group-hover:scale-105 transition-transform duration-500">
                    <img
                ...
                {/* Content */}
                <div>
                  <h2 className="text-3xl md:text-4xl font-medium mb-3 text-white font-['Space_Grotesk',sans-serif]">HUSSIEN BALLOUK</h2>
                  <p className="text-[#3b82f6] mb-6 font-medium text-sm tracking-widest uppercase">FOUNDER & CEO</p>

                  <blockquote className="text-lg text-white/70 mb-8 leading-relaxed font-light italic">
                  ...
                  <div className="flex space-x-4 justify-center">
                    {[
                      ...
                      <motion.a
                        ...
                        className="magnetic w-12 h-12 border border-white/10 rounded-full flex items-center justify-center hover:bg-white text-white hover:text-black transition-all duration-300"
            ...
            {/* Amir Ahmadian */}
            <div className="glass rounded-3xl p-10 relative overflow-hidden group hover:bg-white/[0.06] transition-all duration-500 border border-white/5 hover:border-white/10">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#8b5cf6]/10 to-transparent rounded-full blur-3xl -z-10 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="flex flex-col items-center text-center gap-8">
                ...
                {/* Content */}
                <div>
                  <h2 className="text-3xl md:text-4xl font-medium mb-3 text-white font-['Space_Grotesk',sans-serif]">AMIR AHMADIAN</h2>
                  <p className="text-[#8b5cf6] mb-6 font-medium text-sm tracking-widest uppercase">CHIEF SCIENTIFIC OFFICER</p>
          ...
          >
            <div className="glass p-10 rounded-3xl border border-white/5 hover:bg-white/[0.06] transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-10 h-10 bg-[#3b82f6]/10 rounded-lg flex items-center justify-center">
                  <Brain className="h-5 w-5 text-[#3b82f6]" />
                </div>
                <h3 className="text-2xl font-medium text-white font-['Space_Grotesk',sans-serif]">Expertise</h3>
              </div>
              <ul className="space-y-4">
                {[
                  ...
                  <motion.li
                    key={skill}
                    className="flex items-center text-white/70 font-light"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
            ...
            <div className="glass p-10 rounded-3xl border border-white/5 hover:bg-white/[0.06] transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-medium text-white font-['Space_Grotesk',sans-serif]">Leadership</h3>
              </div>
